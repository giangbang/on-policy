...
do
    ...
    --n_training_threads 1 --n_rollout_threads 16 --num_mini_batch 1 --episode_length 20 --num_env_steps 10000000 \
    ...
    --clip_param 0.1 --opti_eps 1e-8 --use_centralized_V --use_valuenorm \
    --gamma 0.95
    #--use_eval
done
