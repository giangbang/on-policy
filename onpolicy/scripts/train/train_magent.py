...
import torch
from onpolicy.envs.magent import MAgentEnv
from onpolicy.config import get_config
from onpolicy.envs.env_wrappers import ShareSubprocVecEnv, ShareDummyVecEnv

"""Train script for MAgent2."""


def make_train_env(all_args):
    def get_env_fn(rank):
        def init_env():
            if all_args.env_name == "MAgent2":

                env = MAgentEnv(all_args.env_id, seed=all_args.seed)
            else:
...
def parse_args(args, parser):
    parser.add_argument(
        ...
        type=str,
        default="battle_v4",
        help="name of the map name in magent2, this includes battle_v4 and persue",
    )
...
def main(args):
    ...
    # run dir
    plan_dir = all_args.env_name + str(all_args.env_id)
    run_dir = (
    ...
    tmp_env = MAgentEnv(all_args.env_id, seed=all_args.seed)
    print("=" * 10)
    print(tmp_env)
    print("=" * 10)
