...
def get_config():
    ...
    parser.add_argument(
        ...
        type=str,
        default="mappo",
        choices=["rmappo", "mappo", "mappo_mgda", "mappo_mgdapp", "iql"],
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="use MGDA algorithm or not, default False: using MGDA++",
    )
    parser.add_argument(
        "--mgda_eps", type=float, default=5e-2, help="epsilon used in MGDA++"
    )
    ...
    parser.add_argument(
        ...
        action="store_false",
        default=True,
        help="by default True, use greedy actions for evaluation.",
    )
    parser.add_argument(
        "--eval_interval",
        type=int,
    ...
    # use graph/communication
    parser.add_argument(
        "--use_graph",
        action="store_true",
        default=False,
        help="by default, do not use GNN. If set, use Convolutional Graph Net.",
    )
